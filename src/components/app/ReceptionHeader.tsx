...
const navLinks = [
  { href: "/reception/dashboard", label: "Cadastro", icon: LayoutDashboard },
  { href: "/reception/visitors", label: "Visitantes", icon: Users },
];
              ...
              <div className="flex flex-col h-full">
                <div className="flex items-center gap-3 p-4 border-b">
                   <Image
                    ...
                    />
                    <h2 className="font-headline font-bold text-lg">Menu Recepção</h2>
                </div>
